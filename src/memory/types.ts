...
export type SemanticCategory = 
  | 'AboutUser' | 'Work' | 'Projects' | 'Coding' | 'Learning' 
  | 'Goals' | 'Finance' | 'Preferences' | 'CommunicationStyle' 
  | 'Relationships' | 'Health' | 'Diet' | 'Hobbies' | 'Travel' 
  | 'Entertainment' | 'Events' | 'Notes' | 'Another';
